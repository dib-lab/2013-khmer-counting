...
packages, including Tallymer, Jellyfish, BFCounter, DSK, KMC, Turtle
 and KAnalyze. % Is this list too long? -QP
Finally, we examine
...
adopts an %online not online? -QP
...
CountMin Sketch \cite{Cormode2005} , a generalized probabilistic data structure for
...
de Bruijn graph storage and traversal \cite{Pell2012,Jones:2012aa}.
...
are related to CountMin Sketch and our khmer implementation. 
 

% @@CTB this would be the place to extend CMS/CBF discussion.
...
% bloom filter? starndard CMS uses different hash functions for differnt tables -QP
% 
...
above, and chose seven different CountMin Sketch sizes to yield seven
...
functions.
% (see also \cite{adina2013}). seems the wrong citation? -QP
...
generated genome and a set of E. coli reads.}
