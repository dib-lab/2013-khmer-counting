...
k-mers and contain many erroneous k-mers.  For typical values of k such as k=32 the data sets are sparse as only a small fraction of
...
the fourth iteration the false positive rate was down to 3.1\% with 0.0\% of the data removed (Table XXX.).
