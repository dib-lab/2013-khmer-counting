...
%    reads, not k-mers.
% @CTB for disk space, do we want to make it .gzipped?
...
functionality not readily offered by any current packages.  This has
...
DSK performs especially well in terms of memory usage for
...
partition sets of k-mers rather than randomly accessing k-mer
counts.
